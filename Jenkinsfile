    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                sh "docker tag utopiauserms:latest 466486113081.dkr.ecr.us-east-1.amazonaws.com/utopiaairlines/utopiauserms:latest"
                sh "docker push 466486113081.dkr.ecr.us-east-1.amazonaws.com/utopiaairlines/utopiauserms:latest"
            }
        }
        // stage('Deploy') {
        //    steps {
